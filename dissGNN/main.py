...
if __name__ == "__main__":
    ...
    optimiser_TRAN = torch.optim.Adam(model_inst_TRAN.parameters(), lr = learning_rate, weight_decay = weight_decay)

    hidden_size, num_layers, drop_prob, learning_rate, weight_decay = 8, 2, 0.1, 0.1, 0.01
    model_inst_GCN2 = model.GCN2Net(input_size, output_size, hidden_size, num_layers, drop_prob)
    optimiser_GCN2 = torch.optim.Adam(model_inst_GCN2.parameters(), lr = learning_rate, weight_decay = weight_decay)
    ...
    optimiser_GAT2 = torch.optim.Adam(model_inst_GAT2.parameters(), lr = learning_rate, weight_decay = weight_decay)
    ...
    optimiser_SAGE = torch.optim.Adam(model_inst_SAGE.parameters(), lr = learning_rate, weight_decay = weight_decay)
